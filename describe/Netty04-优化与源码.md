...
* 属于操作系统参数，配置一个进程允许打开的文件描述符数量，属于临时配置放在启动脚本中



#### 4）TCP_NODELAY

* 属于 SocketChannal 参数，关闭nagle算法，默认值为false开启了该算法，建议通过childOPtion设置到 ServerSocketChannal 上



#### 5）SO_SNDBUF & SO_RCVBUF 
发送缓冲区和接收缓冲区决定了滑动窗口的上限，现在的操作系统一般不需要调整
